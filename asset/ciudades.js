 ...
 document.addEventListener("DOMContentLoaded", function () {
    ...
    colombiaData.forEach(function (departamento) {
    ...
    // Función para actualizar el select de ciudades según el departamento seleccionado
    departamentoSelect.addEventListener("change", function () {
        ...
        // Buscar las ciudades correspondientes al departamento seleccionado
        var selectedDepartamentoData = colombiaData.find(function (departamento) {
            return departamento.departamento === selectedDepartamento;
        });

        // Llenar el select de ciudades con las ciudades correspondientes
        selectedDepartamentoData.ciudades.forEach(function (ciudad) {
            var option = document.createElement("option");
            option.value = ciudad;
